...
class _PatternCreatorState extends State<PatternCreator> {
  ...
  List<Color> _rightColumnColors = []; // List to hold colors for the right column
            ...
            return AlertDialog(
                ...
                content: Container(
                    ...
                    child: Column(
                        ...
                        children: [
                            ColorPicker(
                                color: isLeftColumn ? _leftColumnColors[index ~/ 2] : _rightColumnColors[index ~/ 2],
                                onChanged: (value) {
                                    setState(() {
                                        if (isLeftColumn) {
  ...
  void _resetContainers() {
    setState(() {
        containerCount = 8; // Ensures the total count remains even and can be evenly split
        _leftColumnColors = List<Color>.generate(containerCount ~/ 2, (index) => Colors.blue);
        _rightColumnColors = List<Color>.generate(containerCount ~/ 2, (index) => Colors.blue);
    });
  ...
  Future<void> loadColors() async {
      ...
      _rightColumnColors = rightColorStrings != null ? rightColorStrings.map(stringToColor).toList() : // Check if rightColorStrings is null
          List.generate(containerCount ~/ 2, (_) => Colors.blue); // Initialize colors if null
                  ...
                  child: GridView.count(
                    ...
                    children: List.generate(containerCount, (index) {
                      ...
                      return Container(
                        ...
                        color: isLeftColumn ? _leftColumnColors[index ~/ 2] : _rightColumnColors[index ~/ 2], // Use individual color for each container
